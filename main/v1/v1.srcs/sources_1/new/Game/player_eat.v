...
output wire [3:0] p1_speed, p1_range, p1_bomb_amount, p2_speed, p2_range, p2_bomb_amount;
...
eat_item Up1_eat_num(
    ...
    .item_1_y(item_position[67:64]),
    .item_2_x(item_position[63:60]),
    .item_2_y(item_position[59:56]),
    .item_3_x(item_position[55:52]),
    .item_3_y(item_position[51:48]),
    .get_item_1(p1_get_num_1), 
    .get_item_2(p1_get_num_2),
    .get_item_3(p1_get_num_3)
);
...
eat_item Up1_eat_len(
    ...
    .item_1_y(item_position[43:40]),
    .item_2_x(item_position[39:36]),
    .item_2_y(item_position[35:32]),
    .item_3_x(item_position[31:28]),
    .item_3_y(item_position[27:24]),
    .get_item_1(p1_get_len_1), 
    .get_item_2(p1_get_len_2),
    .get_item_3(p1_get_len_3)
);
...
eat_item Up1_eat_speed(
    ...
    .item_1_y(item_position[19:16]),
    .item_2_x(item_position[15:12]),
    .item_2_y(item_position[11:8]),
    .item_3_x(item_position[7:4]),
    .item_3_y(item_position[3:0]),
    .get_item_1(p1_get_speed_1), 
    .get_item_2(p1_get_speed_2),
    .get_item_3(p1_get_speed_3)
);
...
eat_item Up2_eat_num(
    ...
    .item_3_x(item_position[55:52]),
    .item_3_y(item_position[51:48]),
    .get_item_1(p2_get_num_1), 
    .get_item_2(p2_get_num_2),
    .get_item_3(p2_get_num_3)
);
...
eat_item Up2_eat_len(
    ...
    .item_3_x(item_position[31:28]),
    .item_3_y(item_position[27:24]),
    .get_item_1(p2_get_len_1), 
    .get_item_2(p2_get_len_2),
    .get_item_3(p2_get_len_3)
);
...
eat_item Up2_eat_speed(
    ...
    .item_3_x(item_position[7:4]),
    .item_3_y(item_position[3:0]),
    .get_item_1(p2_get_speed_1), 
    .get_item_2(p2_get_speed_2),
    .get_item_3(p2_get_speed_3)
);
